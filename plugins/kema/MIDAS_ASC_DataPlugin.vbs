'------------------------------------------------------------------------------
'The DIAdem 11 SP1 DataPlugin Wizard generated this script on 3/31/2009 13:02.
'
...
Sub ReadStore(File)
  ...
  '----------------------------------------------------
  AreaTypes      = Array(eChannelGroup,eChannel)
  AreaLineCounts = Array(3,2)
  DataBeginLine  = GetDataBeginLine(File,AreaTypes,AreaLineCounts)
  '----------------------------------------------------
  GroupPropNames     = Array("Test_No","Date","Time")
  GroupPropDataTypes = Array(eString,eTime,eString)
  GroupPropValues = GetGroupPropValues(File,AreaTypes,AreaLineCounts,GroupName,GroupPropNames,GroupPropDataTypes,NULL,2)
  '----------------------------------------------------
  ChannelPropNames     = Array("name","unit_string")
  ...
  '----------------------------------------------------
  ChannelTypes = Array(eR64,eR64,eIgnore)
...
Sub SetGroupPropFormatter(File)
  ...
  File.Formatter.ExponentSeparator = ""
  File.Formatter.StringSign = ""
  File.Formatter.TimeFormat = "YYYYMMDD"
  File.Formatter.TrimCharacters = " " & vbTab
...
Sub SetChannelValueBlockFormatter(File)
  ...
  File.Formatter.ExponentSeparator = "e"
  File.Formatter.StringSign = ""
  File.Formatter.TimeFormat = "s.ssssssss"
  File.Formatter.TrimCharacters = " " & vbTab
  File.Formatter.NoValueSign = ""
End Sub
