...
select case sel_report
      ...
      case "0"  'single "O"
        ...
        Call Picload(spathdocuments&"ABB_plot_O_010.tdr")
      ...
      case "1"    'single "C"
        ...
        Call Picload(spathdocuments&"ABB_plot_C_011.tdr")
     ...
     if show_tolerance =1 and sample_rate_correct then    
      ...
      case "2"  '"CO" one plot
        ...
        Call Picload(spathdocuments&"ABB_plot_CO_012.tdr")
    ...
    if show_tolerance =1 and sample_rate_correct then    
      ...
      case "3"      '"CO" two plots
        ...
        Call Picload(spathdocuments&"ABB_plot_C_O_013.tdr")
...
if show_tolerance=1 and sample_rate_correct then
      ...
      case "4"    '"O-CO" two plots
        ...
        Call Picload(spathdocuments&"ABB_plot_O_CO_014.tdr")
...
case "5"    '"O-C-O" three plots
        ...
        Call Picload(spathdocuments&"ABB_plot_O_C_O_015.tdr")
...
Masterlayoutlink=spathdocuments&"ABB_Plot_Travel_Master.TDRM"
