...
'-- Author: Kaan Oenen
'-- Comment: This Scripts prints the basic evaluation definitions to a txt file
...
Sub printeva()
  ...
  intHandleWrite = TextFileOpen("C:\Program Files\National Instruments\DIAdem 10.0\abb\eva_basic_print1.txt", tfCreate or tfWrite or tfANSI)
